...
* Maryam Hany Bakr
* Roaa Abd Elhakeem Ramadan
* Maryam Mohamed Mohamed Gomaa
* Rahma Gamal Ali

## Project Overview

Adaha is an inclusive digital platform that empowers people with disabilities by connecting them to jobs and training based on their abilities — not their disabilities.
Built with an accessibility-first approach, it bridges the gap between talent and inclusive workplaces.

## Project Objectives
* Economic Empowerment: Providing real and sustainable job opportunities for people with disabilities.
* Social Integration: Building a bridge of trust between diversity-supporting companies and creative talents from people with disabilities.
